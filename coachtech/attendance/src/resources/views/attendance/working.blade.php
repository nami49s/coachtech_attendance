...
<body>
    ...
    <main>
        <div class="status">
            <p><span class="status-text">出勤中</span></p>
        </div>
        <div class="date-time">
        ...
        <div class="button-container">
            <form class="checkout-form" action="{{ route('attendance.checkout') }}" method="POST">
                @csrf
                <button class="checkout-button" type="submit">退勤</button>
            </form>
            <form class="break-form" action="{{ route('attendance.break.start') }}" method="POST">
                @csrf
